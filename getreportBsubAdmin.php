   ...
   <table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered" border="1" id="example">
                       ...
                       $title='
                                  <tr>
                                   ...
                                   <tr>
                                      <th colspan="9"><center><B>Tickets sent by Sub Administrators from '; if($location=="") $title.=' all  Branch Locations'; else $title.=' : '.$location_name; $title.='</B></center></th>
                                   </tr>
                                   <tr>
...
$slADMr=mysqli_query($connect,"SELECT *,date_format(request.sentOn,'%d/%m/%Y') as sentOndate,date_format(request.assignOn,'%d/%m/%Y') as assignOndate FROM request inner join tickect_category on tickect_category.ticket_category_id=request.ticket_category  inner join location on request.branchLocation = location.locationID inner join subadmin on subadmin.subAdminID=request.sentBy where request.sentCategory=1  and '$date1' <= sentOn  order by requestID desc");}
else if($date1=="" and $date2!=""){
$slADMr=mysqli_query($connect,"SELECT *,date_format(request.sentOn,'%d/%m/%Y') as sentOndate,date_format(request.assignOn,'%d/%m/%Y') as assignOndate FROM request inner join tickect_category on tickect_category.ticket_category_id=request.ticket_category  inner join location on request.branchLocation = location.locationID inner join subadmin on subadmin.subAdminID=request.sentBy where request.sentCategory=1  and  sentOn <= '$date2' order by requestID desc");}
else if($date1!="" and $date2!=""){
$slADMr=mysqli_query($connect,"SELECT *,date_format(request.sentOn,'%d/%m/%Y') as sentOndate,date_format(request.assignOn,'%d/%m/%Y') as assignOndate FROM request inner join tickect_category on tickect_category.ticket_category_id=request.ticket_category  inner join location on request.branchLocation = location.locationID inner join subadmin on subadmin.subAdminID=request.sentBy where request.sentCategory=1 and  '$date1' <= sentOn and sentOn <= '$date2' order by requestID desc");}
}
...
if($location!=""){
if($date1=="" and $date2==""){
$slADMr=mysqli_query($connect,"SELECT *,date_format(request.sentOn,'%d/%m/%Y') as sentOndate,date_format(request.assignOn,'%d/%m/%Y') as assignOndate FROM request inner join tickect_category on tickect_category.ticket_category_id=request.ticket_category  inner join location on request.branchLocation = location.locationID inner join subadmin on subadmin.subAdminID=request.sentBy where subadmin.location='$location' and request.status='$status' and request.sentCategory=1 order by requestID desc");}
else if($date1!="" and $date2==""){
$slADMr=mysqli_query($connect,"SELECT *,date_format(request.sentOn,'%d/%m/%Y') as sentOndate,date_format(request.assignOn,'%d/%m/%Y') as assignOndate FROM request inner join tickect_category on tickect_category.ticket_category_id=request.ticket_category  inner join location on request.branchLocation = location.locationID inner join subadmin on subadmin.subAdminID=request.sentBy where subadmin.location='$location' and request.status='$status' and request.sentCategory=1 and '$date1' <= sentOn  order by requestID desc");}
else  if($date1=="" and $date2!=""){
$slADMr=mysqli_query($connect,"SELECT *,date_format(request.sentOn,'%d/%m/%Y') as sentOndate,date_format(request.assignOn,'%d/%m/%Y') as assignOndate FROM request inner join tickect_category on tickect_category.ticket_category_id=request.ticket_category  inner join location on request.branchLocation = location.locationID inner join subadmin on subadmin.subAdminID=request.sentBy where subadmin.location='$location' and request.status='$status' and request.sentCategory=1 and  sentOn <= '$date2' order by requestID desc");}
else  if($date1!="" and $date2!=""){
$slADMr=mysqli_query($connect,"SELECT *,date_format(request.sentOn,'%d/%m/%Y') as sentOndate,date_format(request.assignOn,'%d/%m/%Y') as assignOndate FROM request inner join tickect_category on tickect_category.ticket_category_id=request.ticket_category  inner join location on request.branchLocation = location.locationID inner join subadmin on subadmin.subAdminID=request.sentBy where subadmin.location='$location' and request.status='$status' and request.sentCategory=1 and '$date1' <= sentOn and sentOn <= '$date2' order by requestID desc");}
}
else if($location==""){
if($date1=="" and $date2==""){
$slADMr=mysqli_query($connect,"SELECT *,date_format(request.sentOn,'%d/%m/%Y') as sentOndate,date_format(request.assignOn,'%d/%m/%Y') as assignOndate FROM request inner join tickect_category on tickect_category.ticket_category_id=request.ticket_category  inner join location on request.branchLocation = location.locationID inner join subadmin on subadmin.subAdminID=request.sentBy where  request.status='$status' and request.sentCategory=1 order by requestID desc");}
else if($date1!="" and $date2==""){
$slADMr=mysqli_query($connect,"SELECT *,date_format(request.sentOn,'%d/%m/%Y') as sentOndate,date_format(request.assignOn,'%d/%m/%Y') as assignOndate FROM request inner join tickect_category on tickect_category.ticket_category_id=request.ticket_category  inner join location on request.branchLocation = location.locationID inner join subadmin on subadmin.subAdminID=request.sentBy where request.status='$status' and request.sentCategory=1 and '$date1' <= sentOn  order by requestID desc");}
else  if($date1=="" and $date2!=""){
$slADMr=mysqli_query($connect,"SELECT *,date_format(request.sentOn,'%d/%m/%Y') as sentOndate,date_format(request.assignOn,'%d/%m/%Y') as assignOndate FROM request inner join tickect_category on tickect_category.ticket_category_id=request.ticket_category  inner join location on request.branchLocation = location.locationID inner join subadmin on subadmin.subAdminID=request.sentBy where  request.status='$status' and request.sentCategory=1 and  sentOn <= '$date2' order by requestID desc");}
else  if($date1!="" and $date2!=""){
$slADMr=mysqli_query($connect,"SELECT *,date_format(request.sentOn,'%d/%m/%Y') as sentOndate,date_format(request.assignOn,'%d/%m/%Y') as assignOndate FROM request inner join tickect_category on tickect_category.ticket_category_id=request.ticket_category  inner join location on request.branchLocation = location.locationID inner join subadmin on subadmin.subAdminID=request.sentBy where  request.status='$status' and request.sentCategory=1 and '$date1' <= sentOn and sentOn <= '$date2' order by requestID desc");}
}
if(mysqli_num_rows($slADMr)>0){
  while($showr=mysqli_fetch_array($slADMr)){
    $ikd=$showr['requestID'];
 ...
 { 
    ...
    if(mysqli_num_rows($slADM)>0)
    {
      ...
      $urlHs=(24967*$show['requestID'])+325649;
                  ...
                  <td>'.$show['location_name'].'</td>
                  <td>'.$show['sentOndate'].'</td>';
           if($show['sentCategory']==0) {  $output.=' <td>'.$show['user_lname'].' '.$show['user_lname'].'</td>';  } else if($show['sentCategory']==1)  {  $output.='<td>'.$show['subAdmin_fname'].' '.$show['subAdmin_lname'].'</td>'; } else if($show['sentCategory']==2)  {  $output.='<td>'.$show['admin_fname'].' '.$show['admin_lname'].'</td>'; } 
