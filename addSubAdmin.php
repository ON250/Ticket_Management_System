...
if(isset($_POST['addAdmin']))
{
  ...
  $passworde='BDF@2019';
  $password=sha1($passworde);
  $regist=mysqli_query($connect,"INSERT INTO subadmin(subAdmin_fname,subAdmin_lname,subAdmin_email,subAdmin_telephone,subAdmin_adress,subAdmin_status,subAdmin_pin,subAdmin_password,c_date,subAdmin_qualification,location) values('$fname','$lname','$email','$telephone','$adress','$status',0,'$password',NOW(),'$qualification','$location')");
  if($regist) echo '<script>alert("New Sub-Admin Account was created successfully! Default Password  : '.$passworde.'")</script>';
          ...
          <div class="row">
            <div class="col-md-6">
              ...
              <div class="form-group">
                ...
                <input type="number" class="form-control select2"  style="width: 100%;"  name="telephone" required="">
              </div>
            </div>
            <!-- /.col -->
            <div class="col-md-6">
              ...
              <div class="form-group">
                ...
                <select class="form-control select2"  style="width: 100%;"  name="qualification" required="s">
...
<?php } } ?>
              ...
              <input type="submit" name="addAdmin" value="Register Sub-Admin" class="pull-right btn btn-sm btn-primary" >
            </div>
            <!-- /.col -->
          </div>
        </form><!--Form-->
