...
?>
  ...
  if(isset($_POST['delete'])){
    ...
    if($Delete) { 
          echo '<script>alert("Department was Deleted Succsesffuly! ")</script>';
  } 
...
?>
                <tr>
                  ...
                  <td><a href="editDeparment.php?rSh=<?php echo $urlHs;?>" class="btn btn-default btn-xs glyphicon glyphicon-pencil"></a> <a href="" class="btn btn-default btn-xs glyphicon glyphicon-remove" data-toggle="modal" <?php  echo 'data-target="#remove'.$show['departID'].'ers"'; ?> > </a></td>
                </tr>
<?php $count++; } } ?>
              </tbody>
              </table>
...
<?php 
$count=1;
$slADM=mysqli_query($connect,"SELECT * FROM department order by departID desc");
if(mysqli_num_rows($slADM)>0){
  while($show=mysqli_fetch_array($slADM)){
?>
    <div class="modal fade"  <?php  echo 'id="remove'.$show['departID'].'ers"';?> tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          <div class="modal-header"><p class="modal-title" id="exampleModalLabel">BDF Ticket <span class="text-muted"> | Delete Departement</span></p></div>
          <div class="modal-body">
           <div class="" style="padding-right: 10px;padding-left: 10px;">
              <form method="post" action="" class="form-group" style="shape-margin: 20px;">
              <center><label>Do you want To delete This Department?</label><br>
              <input type="test" hidden="" value="<?php echo $show['departID'];?>" name="departID">
